...
class Primesize(m.Scene):
    def construct(self):
        ...
        enh_split_sum = m.MathTex(
                ...
                "{} = L")
        text3 = m.Tex(r"Call all the primes below $K$", 
                r" \emph{small primes},\\", 
                "and all primes larger than $K$", 
                r" \emph{large primes}")
        ...
        self.play(m.Write(m.VGroup(text1[0], orig_sum)))
        self.wait(2)
        self.play(m.Write(text1[1]))
        ...
        self.play(m.Write(split_sum[0][7:10]))
        self.wait(2)
        self.play(m.Write(split_sum[1][8:11]))
        self.wait(2)
        self.play(m.Write(split_explain[0][:15]))
        self.wait(2)
        self.play(m.Write(split_explain[0][15:]))
        self.wait(3)
        self.play(m.Write(split_explain[1]))
        ...
        self.wait(1)
        self.play(m.Indicate(text3[1]), m.Indicate(s))
        self.wait(1)
        self.play(m.Write(text3[2:]))
        self.play(m.Indicate(text3[3]), m.Indicate(orig_sum[0]))
        self.wait()
